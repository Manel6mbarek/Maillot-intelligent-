...
void handleroot()
{
  ...
  {Serial.println("ATTENTION!! votre enfant est en danger");}
  delay(300);
  ...
  ("<html><head><meta http-equiv='refresh' content='3'</meta>"
   "<h1 style=text-align:center;font-size:300%;color:blue;font-family:britannic bold;>Position de l'enfant</h1>");
   server.sendContent
  ...
  if( yAccl < 0 ) 
   server.sendContent
  ("<h3 style=text-align:center;font-family:tahoma;color:red;>  " + String("ATTENTION !!votre enfant est en danger"));

  server.sendContent
  ("<html><head><meta http-equiv='refresh' content='3'</meta>"
   "<h1 style=text-align:center;font-size:300%;color:blue;font-family:britannic bold;>la temperature ambiante est :</h1>");
